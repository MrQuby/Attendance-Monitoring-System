        ...
        <aside class="sidebar">
            <div>
                ...
                <ul class="sidebar-menu">
                    <li><a href="admin_dashboard.php?section=dashboard" id="dashboard-link" class="sidebar-link"><i class="bx bx-home"></i> Dashboard</a></li>
                    <li><a href="admin_dashboard.php?section=student-list" id="student-list-link" class="sidebar-link"><i class="bx bx-group"></i> Student List</a></li>
                    <li><a href="admin_dashboard.php?section=attendance" id="attendance-link" class="sidebar-link"><i class="bx bx-calendar"></i> Attendance</a></li>
                    <li><a href="logout.php" class="sidebar-link"><i class="bx bx-log-out"></i> Logout</a></li>
                </ul>
            </div>
